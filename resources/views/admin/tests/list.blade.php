                ...
                <table class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$item->title}} </td>
                            <td>
                                <a class="btn delete-btn dt-button buttons-pdf buttons-html5  purple btn-outline" href="{{route('adgetEditTest', ['id' => $item->id]) . '?query='. request()->query('query')}}"><i class="fa fa-pencil-square-o"></i></a>
                            </td>
                            <td>
                                <a class="btn delete-btn dt-button buttons-pdf buttons-html5 red btn-outline" href="{{route('adgetDelTest', ['id' => $item->id]) . '?query='. request()->query('query')}}" onclick="return confirm('Bạn có chắc chắn xóa bài test này?');">
