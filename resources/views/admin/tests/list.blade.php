                ...
                <table class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn delete-btn dt-button buttons-pdf buttons-html5 red btn-outline" href="{{route('adgetDelTest', ['id' => $item->id]) }}" onclick="return confirm('Bạn có chắc chắn xóa bài test này?');">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7">
                        <div class="dataTables_paginate paging_bootstrap_extended" id="sample_2_paginate">
                            <div class="pagination-panel"> Trang <a href="{{route('adgetListTest', ['page' => $data->prev]). '?query='. request()->query('query')}}" class="btn btn-sm default prev @if($data->page == 1) disabled @endif">
                                ...
                                <a href="{{route('adgetListTest', ['page' => $data->next]). '?query='. request()->query('query')}}" class="btn btn-sm default next @if($data->page == $data->sum) disabled @endif">
